...
class DatePicker extends Component {
  ...
  renderInputLabel = () => (
    <InputLabel shrink htmlFor="requestedShipDate">
      {this.props.label}
    </InputLabel>
  );
  ...
  renderHelperText = () => (
    <FormHelperText error={this.props.FormHelperTextProps && this.props.FormHelperTextProps.error}>
  ...
  renderCalendar = () => (
    <Popper open={Boolean(this.state.showCalendar)} anchorEl={this.state.el} placement="bottom-end">
      <Paper>
